...
for item in val_dataset:
    ...
    text_prompt = (
        ...
        f"Moreover, these are the coordinates of some similar images: ({dataset['LAT'][indices[0][0]]}, {dataset['LON'][indices[0][0]]})"
        "Your answer:"
    )
    ...
    if pred_coords is None:
        ...
        # pred_coors = [top3_city_names[0]['center'][0], top3_city_names[0]['center'][1]]
    elif pred_coords[0] == 0 or pred_coords[0] == 0:
         pred_coords = [dataset['LAT'][indices[0][0]], dataset['LON'][indices[0][0]]]
        # pred_coords[0] = [top3_city_names[0]['center'][0], top3_city_names[0]['center'][1]]
    # 4. 计算误差
    # print(pred_coords, gt_coords)
    # print(top3_city_names)
